...
console.log("i want to find the index of mango and index is : ", fruits.indexOf("mango"))
...
console.log("i want to find the watermelon is available in fruit and the answer is: ", fruits.includes("watermelon"))

// now i want to check orange i  available in fruit array or not :

console.log("now i want to find the orange is available in fruit and the answer is: ", fruits.includes("orange"))
...
console.log("Sorting number array in descending order: ",numArray.sort((a,b)=> b-a))
