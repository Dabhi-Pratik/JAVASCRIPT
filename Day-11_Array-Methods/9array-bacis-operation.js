...
console.log("index of  number greater than five in numArray is : ", numGreaterThan5index)
...
console.log("fruit array op with splice adding one more fruits in second index op : ", fruits.splice(2, 0, "orange"))
...
console.log("num greater than 100 is available ?", num.some((value) => value > 5))

// now every() method will check every element in array if every element satisfies the condition then try otherwise false


console.log("checking every elements that num greater than 5 is available :", num.every((value) => value > 5))
...
console.log("check number every number  is greater than 1 or not ?", num.every((value) => value > 1))
